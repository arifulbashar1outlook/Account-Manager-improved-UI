                                ...
                                <div key={day} className="space-y-2">
                                    <div className="flex justify-between items-center px-2">
                                        <div className="flex items-center gap-2">
                                            <span className="w-8 h-8 rounded-full bg-md-primary text-white flex items-center justify-center text-[10px] font-black">{day}</span>
                                        ...
                                        <div className="text-right flex items-center gap-3">
                                            <div className="flex flex-col items-end">
                                                ...
                                                <p className="text-xs font-black text-rose-600">Tk {dayOut.toLocaleString()}</p>
                                            </div>
                                            <div className="flex flex-col items-end border-l pl-3 border-gray-100">
                                                <p className="text-[8px] font-black text-emerald-500 uppercase tracking-widest">Net Flow</p>
                                                <p className={`text-xs font-black ${dayIn - dayOut >= 0 ? 'text-emerald-600' : 'text-rose-600'}`}>
                                        ...
                                        {dayTx.map((t, idx) => (
                                            <div key={t.id} className={`p-4 flex justify-between items-center ${idx !== dayTx.length - 1 ? 'border-b border-gray-50 dark:border-zinc-800' : ''}`}>
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p className="text-sm font-bold text-md-on-surface truncate max-w-[150px]">{t.description}</p>
