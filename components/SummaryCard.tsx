  ...
  return (
    <div className="glass rounded-md-card p-5 flex flex-col justify-between transition-all hover:bg-white/80 dark:hover:bg-zinc-800/80 active:scale-[0.97] shadow-sm group">
      <div className="flex items-center gap-3 mb-3">
        ...
        <p className="text-md-on-surface-variant dark:text-gray-400 text-[10px] font-medium tracking-[0.2em] uppercase opacity-60 whitespace-nowrap">{title}</p>
      </div>
      <div>
        <h3 className={`text-xl font-black tracking-tighter flex items-baseline flex-wrap ${colorClass}`}>
          <span className="text-[10px] font-medium opacity-40 mr-1">Tk</span>
